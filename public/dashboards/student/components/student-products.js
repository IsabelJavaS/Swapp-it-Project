    ...
    render() {
        this.shadowRoot.innerHTML = `
            <style>
                ...
                .products-header { font-size: 1.5rem; font-weight: 700; margin-bottom: 1.5rem; color: #667eea; }
                ...
                .btn { padding: 0.5rem 1.25rem; border-radius: 8px; border: none; background: #667eea; color: white; font-weight: 600; cursor: pointer; transition: background 0.2s; margin-left: 1rem; }
                .btn:hover { background: #764ba2; }
            </style>
            <div class="products-container">
                <div class="products-header">Mis Productos</div>
                <div class="product-list">
                    <div class="product-card">
                        <img class="product-img" src="https://via.placeholder.com/80" alt="Producto" />
                        <div class="product-info">
                            <div class="product-title">Libro de Matemáticas</div>
                            <div class="product-meta">Categoría: Libros | Estado: Como nuevo</div>
                        </div>
                    ...
                    <div class="product-card">
                        <img class="product-img" src="https://via.placeholder.com/80" alt="Producto" />
                        <div class="product-info">
                            <div class="product-title">Mochila Escolar</div>
                            <div class="product-meta">Categoría: Mochilas | Estado: Bueno</div>
                        </div>
                        <button class="btn">Editar</button>
                        <button class="btn">Eliminar</button>
                    </div>
