    ...
    render() {
        this.shadowRoot.innerHTML = `
            <style>
                ...
                .sales-header { font-size: 1.5rem; font-weight: 700; margin-bottom: 1.5rem; color: #667eea; }
                ...
                .sale-date { color: #764ba2; font-size: 0.9rem; }
            </style>
            <div class="sales-container">
                <div class="sales-header">Mis Ventas</div>
                <div class="sales-list">
                    <div class="sale-card">
                        <img class="sale-img" src="https://via.placeholder.com/60" alt="Venta" />
                        <div class="sale-info">
                            <div class="sale-title">Libro de Física</div>
                            <div class="sale-meta">Comprador: Ana López</div>
                            <div class="sale-date">Vendido: 2024-06-02</div>
                        </div>
                    </div>
                </div>
            </div>
