// Componente web para configuraciones del estudiante
                ...
                <div class="settings-grid">
                    ...
                    <div class="settings-section">
                        ...
                        <div class="setting-item">
                            <div class="setting-info">
                                ...
                                <div class="setting-description">Receive updates about your account via email</div>
                            </div>
                    ...
                    <div class="settings-section">
                        ...
                        <div class="setting-item">
                            ...
                            <div class="setting-control">
                                <input type="checkbox" class="toggle-switch" id="pushNotifications" checked>
                                <span class="toggle-label enabled">Enabled</span>
                            </div>
                        </div>
                        ...
                        <div class="setting-item">
                            <div class="setting-info">
                                <div class="setting-label">Sales Alerts</div>
                                <div class="setting-description">Get notified when your products are sold</div>
                            </div>
                            <div class="setting-control">
                                <input type="checkbox" class="toggle-switch" id="salesAlerts" checked>
                                <span class="toggle-label enabled">Enabled</span>
                            </div>
                        </div>
                        ...
                        <div class="setting-item">
                            ...
                            <div class="setting-control">
                                <input type="checkbox" class="toggle-switch" id="messageNotifications" checked>
                                <span class="toggle-label enabled">Enabled</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="settings-section">
                        ...
                        <div class="setting-item">
                            ...
                            <div class="setting-control">
                                <input type="checkbox" class="toggle-switch" id="dataCollection" checked>
                                <span class="toggle-label enabled">Enabled</span>
                            </div>
                        </div>
                        ...
                        <div class="setting-item">
                            <div class="setting-info">
                                ...
                                <div class="setting-description">Use your location for nearby product searches</div>
                            </div>
                            <div class="setting-control">
