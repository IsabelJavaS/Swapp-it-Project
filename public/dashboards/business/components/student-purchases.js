    ...
    render() {
        this.shadowRoot.innerHTML = `
            <style>
                ...
                .purchases-header { font-size: 1.5rem; font-weight: 700; margin-bottom: 1.5rem; color: #3468c0; }
                ...
                .purchase-date { color: #3468c0; font-size: 0.9rem; }
            </style>
            <div class="purchases-container">
                <div class="purchases-header">My Purchases</div>
                <div class="purchase-list">
                    <div class="purchase-card">
                        <img class="purchase-img" src="https://via.placeholder.com/60" alt="Purchase" />
                        <div class="purchase-info">
                            <div class="purchase-title">University Notebook</div>
                            <div class="purchase-meta">Seller: John Perez</div>
                            <div class="purchase-date">Purchased: 2024-06-01</div>
                        </div>
                    </div>
                </div>
            </div>
