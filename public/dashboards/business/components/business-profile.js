...
class BusinessProfile extends HTMLElement {
    ...
    updateProfileInterface(userProfile) {
        ...
        const categoryInput = this.shadowRoot.getElementById('category');
        const websiteInput = this.shadowRoot.getElementById('website');

        let displayName = 'Business';
        let role = 'Business Owner';
        ...
        if (userProfile.role === 'business' && userProfile.business) {
            ...
            role = userProfile.role === 'business' ? 'Business Owner' : 'Student';
        }
        ...
        if (descriptionInput) descriptionInput.value = userProfile.business?.descripcion || 'Professional business providing quality products and services.';
        if (categoryInput) categoryInput.value = userProfile.business?.categoria || 'Technology';
        if (websiteInput) websiteInput.value = userProfile.business?.sitioWeb || 'https://www.example.com';
    }
        ...
        this.shadowRoot.innerHTML = `
            ...
            <div class="profile-overview">
                ...
                <div class="profile-header">
                    ...
                    <p class="profile-role" id="profileRole">Business Owner</p>
                ...
                <div class="profile-content">
                    ...
                    <div class="profile-section">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-input" type="text" id="businessName" placeholder="Enter your business name" disabled />
                        </div>
                        
                        <div class="form-group">
                            <label class="form-label">Email</label>
                            <input class="form-input" type="email" id="email" placeholder="business@example.com" disabled />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-textarea" id="description" placeholder="Describe your business..." disabled></textarea>
                        </div>
                    </div>
                    ...
                    <div class="profile-section">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-input" type="text" id="address" placeholder="Business address" disabled />
                        </div>
                        
                        <div class="form-group">
                            <label class="form-label">Category</label>
                            <input class="form-input" type="text" id="category" placeholder="Business category" disabled />
                        </div>
                        
                        <div class="form-group">
                            <label class="form-label">Website</label>
                            <input class="form-input" type="url" id="website" placeholder="https://www.yourbusiness.com" disabled />
                        </div>
                    </div>
                </div>
            </div>
